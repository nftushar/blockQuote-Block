...
**[Demos](https://bblockswp.com/demo/blockquote/)**
...
= How to use =
- First, install the blockquote plugin
- Add the blockquote block from the block category called "Widgets" in the Gutenberg editor.
...
2. Search For **blockquote**
3. Click on the **blockquote** to add the block

= Download & Upload: =
1. Download the **blockquote** plugin (*.zip file*)
2. In your admin area, go to the Plugins menu and click on **Add New**
3. Click on **Upload Plugin** and choose the **`blockquote.zip`** file and click on **Install Now**
4. Activate the plugin and Enjoy!

= Manually: =
1. Download and upload the **blockquote** plugin to the **`/wp-content/plugins/`** directory
...
Yes, blockquote is a free Gutenberg block plugin.
...
You can post your questions on the [support forum here](https://wordpress.org/support/plugin/blockquote/)
